...
Create issues in Linear using the Linear CLI: `linear issue create` (or `npx -y @schpet/linear-cli issue create` if not globally installed). Do NOT ask the user to review first — just file and share URLs.
