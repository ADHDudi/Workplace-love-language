...
export function AccountActions({ onOpenDashboard, showEmail = true }: AccountActionsProps) {
    ...
    <>
      ...
      {user ? (
        <div className="flex items-center gap-2 md:gap-3">
          {showEmail && <span className="text-xs md:text-sm text-slate-600 hidden md:inline" dir="ltr">{user.email}</span>}
