      ...
      >
        ...
        <motion.footer variants={itemVariants} className="mt-auto pt-6 border-t border-[var(--border-faint)] w-full flex flex-col items-center gap-6 text-xs text-[var(--fg-muted)] pb-4">
          <a 
            ...
            dir="ltr"
            className="transition-transform hover:scale-105 active:scale-95 z-10 flex flex-col items-center gap-1 opacity-80"
          >
          ...
          <nav className="flex items-center gap-4 mt-3 w-full justify-center">
            <Link to="/terms" className="hover:text-[var(--fg)] hover:underline active:opacity-70">{l.terms}</Link>
            <Link to="/privacy" className="hover:text-[var(--fg)] hover:underline active:opacity-70">{l.privacy}</Link>
            <Link to="/accessibility" className="hover:text-[var(--fg)] hover:underline active:opacity-70">{l.accessibility}</Link>
          </nav>
        </motion.footer>
      </motion.div>
    </div>
